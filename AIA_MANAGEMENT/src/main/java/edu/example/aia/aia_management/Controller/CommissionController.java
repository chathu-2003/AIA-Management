...
import edu.example.aia.aia_management.Model.CommissionModel;
...
public class CommissionController {
    ...
    void BtnSaveOnAction(ActionEvent event) {
        if (validateFields()) {
            try {
                ...
                boolean isSaved = CommissionModel.saveCommission(commission);
                if (isSaved) {
    ...
    void BtnUpdateOnAction(ActionEvent event) {
        if (validateFields()) {
            try {
                ...
                boolean isUpdated = CommissionModel.updateCommission(commission);
                if (isUpdated) {
    ...
    void BtnDeleteOnAction(ActionEvent event) {
        if (validateFields()) {
            try {
                ...
                boolean isDeleted = CommissionModel.deleteCommission(commissionId);
                if (isDeleted) {
    ...
    private void loadTableData() {
        try {
            List<CommissionDTO> commissionList = CommissionModel.getAllCommissions();
    ...
    void BtnSearchOnAction(ActionEvent event) {
        ...
        try {
            ...
            CommissionDTO commission = CommissionModel.searchCommission(commissionId);

            if (commission != null) {
                // Populate the fields with the retrieved commission details
                TxtCommision.setText(String.valueOf(commission.getCommissionId()));
                TxtAgent.setText(String.valueOf(commission.getAgentId()));
                TxtAmount.setText(commission.getAmount().toString());
                TxtDate.setText(commission.getDate().toString());
