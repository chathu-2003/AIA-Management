...
public class SupportTicketController {
    ...
    void BtnUpdateOnAction(ActionEvent event) {
        try {
            ...
            boolean isUpdated = SupportTicketModel.updateSupportTicket(ticket);
            if (isUpdated) {
    ...
    void BtnDeleteOnAction(ActionEvent event) {
        try {
            ...
            boolean isDeleted = SupportTicketModel.deleteSupportTicket(supportTicketId);
            if (isDeleted) {
    ...
    private void loadTableData() {
        try {
            List<SupportTicketDto> ticketList = SupportTicketModel.getAllSupportTickets();
