...
public class ManagerController {
    ...
    public ManagerBo managerBo=(ManagerBo) BOFactory.getInstance().getBO(BOFactory.BOType.MANAGER);
    ...
    private void loadManagers() {
        try {
            List<ManagerDto> managers = managerBo.loadManagers();
    ...
    void BtnUpdateOnAction(ActionEvent event) {
        try {
            ...
            if (managerBo.updateManager(manager)) {
    ...
    void BtnDeleteOnAction(ActionEvent event) {
        try {
            ...
            if (managerBo.deleteManager(managerId)) {
    ...
    private void getNextManagerId() {
        try {
            String nextManagerId = String.valueOf(managerBo.getNextManagerId()); // Call the new method in ManagerModel
