...
public class ClaimController {
    ...
    public ClaimBO claimBO=(ClaimBO) BOFactory.getInstance().getBO(BOFactory.BOType.CLAIM);
    ...
    public void loadTable() {
        try {
            ObservableList<ClaimDto> claimList = FXCollections.observableArrayList(claimBO.getAllClaims());
    ...
    void BtnDelectOnAction(ActionEvent event) {
        ...
        if (selectedClaim != null) {
            try {
                if (claimBO.deleteClaim(selectedClaim.getClaimId())) {
    ...
    private void setNextClaimId() {
        try {
            int nextClaimId = claimBO.getNextClaimId(); // Call the method in ClaimModel
