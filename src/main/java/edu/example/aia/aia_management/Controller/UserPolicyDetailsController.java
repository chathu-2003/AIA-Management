...
//import edu.example.aia.aia_management.edu.example.aia.aia_management.Model.UserPolicyDetailsModel;
...
public class UserPolicyDetailsController {
    ...
    public UserPolicyDetailsBo userPolicyDetailsBo=(UserPolicyDetailsBo) BOFactory.getInstance().getBO(BOFactory.BOType.USERDETAILS);
    ...
    void BtnSaveOnAction(ActionEvent event) {
        try {
            ...
            boolean isSaved = userPolicyDetailsBo.saveUserPolicyDetails(userPolicyDetailsDto);
            if (isSaved) {
                loadUserPolicyDetails();
    ...
    void BtnUpdateOnAction(ActionEvent event) {
        try {
            ...
            if (selectedItem != null) {
                ...
                boolean isUpdated = userPolicyDetailsBo.updateUserPolicyDetails(selectedItem);
                if (isUpdated) {
                    loadUserPolicyDetails();
    ...
    void BtnDelectOnAction(ActionEvent event) {
        try {
            UserPolicyDetailsDto selectedItem = TableUserpolicyDetails.getSelectionModel().getSelectedItem();
            if (selectedItem != null) {
                boolean isDeleted = userPolicyDetailsBo.deleteUserPolicyDetails(selectedItem.getUserPolicyDetailsId());
                if (isDeleted) {
    ...
    void BtnSearchOnAction(ActionEvent event) {
        try {
            ...
            List<UserPolicyDetailsDto> searchResults = userPolicyDetailsBo.searchUserPolicyDetails(userId);
    ...
    private void loadUserPolicyDetails() {
        try {
            List<UserPolicyDetailsDto> userPolicyDetailsList = userPolicyDetailsBo.getAllUserPolicyDetails();
    ...
    void BtnBackOnAction(ActionEvent event)throws IOException {
        pageuserpolicy.getChildren().clear();
        pageuserpolicy.getChildren().add(FXMLLoader.load(getClass().getResource("/view/Homepage.fxml")));
    }
