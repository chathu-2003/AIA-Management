...
public class FeedBackController {
    ...
    public FeedBackBo feedBackBo=(FeedBackBo) BOFactory.getInstance().getBO(BOFactory.BOType.FEEDBACK);
    @FXML
    ...
    private void loadFeedbackData() {
        try {
            List<FeedBackDto> feedbackList = feedBackBo.getAllFeedback();
    ...
    void BtnSaveOnAction(ActionEvent event) {
        if (validateFields()) {
            try {
                ...
                if (feedBackBo.saveFeedback(feedback)) {
    ...
    void BtnDeleteOnAction(ActionEvent event) {
        if (validateFields()) {
            try {
                ...
                if (feedBackBo.deleteFeedback(feedbackId)) {
    ...
    void BtnUpdateOnAction(ActionEvent event) {
        if (validateFields()) {
            try {
                ...
                FeedBackDto feedback = new FeedBackDto(feedbackId, managerId, feedbackDate, comment);
                if (feedBackBo.updateFeedback(feedback)) {
    ...
    private void getNextFeedbackId() {
        try {
            String nextFeedbackId = String.valueOf(feedBackBo.getNextFeedbackId()); // Call the new method in FeedBackModel
    ...
    void BtnSearchOnAction(ActionEvent event) {
        ...
        try {
            ...
            FeedBackDto feedback = feedBackBo.searchFeedbackById(feedbackId);
