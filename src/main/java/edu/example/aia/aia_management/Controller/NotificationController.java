...
public class NotificationController {
    ...
    public NotificationBo notificationBO=(NotificationBo) BOFactory.getInstance().getBO(BOFactory.BOType.NOTIFICATION);
    ...
    private void loadTableData() {
        try {
            ...
            notificationList.addAll(notificationBO.getAllNotifications());
    ...
    void BtnSaveOnAction(ActionEvent event) {
        try {
            ...
            boolean isSaved = notificationBO.saveNotification(notificationDto);
    ...
    void BtnUpdateOnAction(ActionEvent event) {
        try {
            ...
            NotificationDto notificationDto = new NotificationDto(notificationId, userId, message, date);
            boolean isUpdated = notificationBO.updateNotification(notificationDto);
    ...
    void BtnDeleteOnAction(ActionEvent event) {
        try {
            int notificationId = Integer.parseInt(TxtNotificationId.getText());
            boolean isDeleted = notificationBO.deleteNotification(notificationId);
